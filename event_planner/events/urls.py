...
urlpatterns = [
    ...
    path('venues/<uuid:pk>/', views.VenueRetrieveUpdateDestroyView.as_view(), name='venue-detail'),

    # Speaker URLs
    path('speakers/', views.SpeakerListCreateView.as_view(), name='speaker-list-create'),
    path('speakers/<uuid:pk>/', views.SpeakerRetrieveUpdateDestroyView.as_view(), name='speaker-detail'),

    # Sponsor URLs
    path('sponsors/', views.SponsorListCreateView.as_view(), name='sponsor-list-create'),
    path('sponsors/<uuid:pk>/', views.SponsorRetrieveUpdateDestroyView.as_view(), name='sponsor-detail'),
